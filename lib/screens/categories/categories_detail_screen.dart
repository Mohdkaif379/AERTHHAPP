...
class _CategoryDetailScreenState extends State<CategoryDetailScreen> {
  ...
  Future<void> _toggleWishlist(_ProductData product) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && decoded['status'] == true) {
        ...
        // Pick up the reliability fetch after a delay
  ...
  void _onNavbarIndexChanged(int index) {
    if (index == 1) {
      // Already in Category section (specifically details), 
      // tapping Category tab returns to Category list
      Navigator.of(context).pop();
    } else {
      // Go back to main and switch tab
      Navigator.of(context).pop();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: PremiumBottomNavBar(
        currentIndex: 1, // Category is index 1
  ...
  Widget _buildBody() {
    ...
    return GridView.builder(
      padding: const EdgeInsets.fromLTRB(16, 12, 16, 110), // Increased bottom padding for navbar
